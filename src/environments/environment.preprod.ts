//url api strapi preprod
const apiUrl = 'https://hd-strapi-preprod-dot-bdv-front-app.appspot.com';
...
export const environment = {
  ...
  apiUsersUrl: 'https://bdv-users-dot-bdv-apis-preprod.appspot.com/v1',
